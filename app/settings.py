...
RABBIT_QUEUE = os.getenv("SEFT_PUBLISHER_RABBIT_QUEUE", "Seft.CollectionInstruments")
...
FTP_FOLDER = os.getenv('SEFT_PUBLISHER_FTP_FOLDER', '.')

SDX_SEFT_CONSUMER_KEYS_FILE = os.getenv('SDX_SEFT_PUBLISHER_KEYS_FILE', './sdx_test_keys/keys.yml')
